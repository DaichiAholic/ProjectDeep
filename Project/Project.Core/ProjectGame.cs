...
namespace Project.Core
{
    ...
    public class ProjectGame : Game
    {
        ...
        private SettingsManager<ProjectSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<ProjectLeaderboard> leaderboardManager;
        ...
        public ProjectGame()
        {
            ...
            settingsManager = new SettingsManager<ProjectSettings>(storage);
            Services.AddService(typeof(SettingsManager<ProjectSettings>), settingsManager);

            leaderboardManager = new SettingsManager<ProjectLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<ProjectLeaderboard>), leaderboardManager);
